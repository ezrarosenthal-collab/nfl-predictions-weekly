...
from app.json_utils import load_json_safely
...
def _load_all_predictions(season: int) -> dict[int, dict]:
    ...
    same reasoning as app/json_utils.load_json_safely: these files are
    auto-generated by scheduled workflows that can collide with each
    other, and one bad file shouldn't take down grading for every other
    week that's fine.
    """
    out = {}
